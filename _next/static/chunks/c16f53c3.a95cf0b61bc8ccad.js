...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([
    [5501], {
        913: function(e, t, n) {
            ...
            let h = !1,
                v = 0,
                p = () => "floating-ui-" + Math.random().toString(36).slice(2, 6) + v++,
                C = a.useId || function() {
            ...
            function k(e) {
                ...
                }), r = e.rootContext || n, u = r.elements, [o, f] = l.useState(null), [s, a] = l.useState(null), m = (null == u ? void 0 : u.reference) || o, h = l.useRef(null), v = R();
                d(() => {
                    m && (h.current = m)
                }, [m]);
                let p = (0, i.YF)({ ...e,
            ...
            let T = e => ({
                ...
                async fn(t) {
                    ...
                    if (!p) return {};
                    let C = { ...t,
                            ...await (0, i.cv)(-p.offsetTop - v.clientTop - h.reference.height / 2 - p.offsetHeight / 2 - u).fn(t)
                        },
                        M = (null == g ? void 0 : g.current) || v,
                        x = await (0, s.US)(H(C, M.scrollHeight), d),
                        y = await (0, s.US)(C, { ...d,
                    ...
                    return M.style.maxHeight = b + "px", M.scrollTop = R, l && (M.offsetHeight < p.offsetHeight * Math.min(a, n.current.length - 1) - 1 || y.top >= -m || y.bottom >= -m ? f.flushSync(() => l(!0)) : f.flushSync(() => l(!1))), r && (r.current = await (0, s.US)(H({ ...C,
                        y: k
                    }, M.offsetHeight), d)), {
                        y: k
                    }
            ...
            function K(e, t) {
                let {
                    ...
                    scrollRef: i,
                    onChange: s
                } = t, a = g(s), m = l.useRef(!1), d = l.useRef(null), h = l.useRef(null);
                l.useEffect(() => {
                    if (!o) return;
