            ...
            function u(e) {
                for (var t = 1; t < arguments.length; t++) {
                    ...
                    t % 2 ? c(Object(r), !0).forEach(function(t) {
                        var n, i;
                        n = t, i = r[t], (n = h(n)) in e ? Object.defineProperty(e, n, {
                            value: i,
                            enumerable: !0,
                            configurable: !0,
                            writable: !0
                            ...
                            return i.default.cloneElement(this.props.appendDots(v), function(e) {
                                for (var t = 1; t < arguments.length; t++) {
                                    ...
                                    t % 2 ? l(Object(r), !0).forEach(function(t) {
                                        var n, i;
                                        n = t, i = r[t], (n = c(n)) in e ? Object.defineProperty(e, n, {
                                            value: i,
                                            enumerable: !0,
                                            configurable: !0,
                                            writable: !0
        ...
        4644: function(e, t, r) {
            ...
            t.InnerSlider = function(e) {
                ...
                function y(e) {
                    ! function(e, t) {
                        if (!(e instanceof t)) throw TypeError("Cannot call a class as a function")
                    }(this, y), w(g(t = f.call(this, e)), "listRefHandler", function(e) {
                        return t.list = e
        ...
        7766: function(e, t, r) {
                ...
                S = function(e) {
                    ...
                    return (n.default.Children.forEach(e.children, function(d, f) {
                        ...
                        if (r.push(n.default.cloneElement(p, {
                            ...
                            var O = l - f;
                            O <= (0, o.getPreClones)(e) && ((t = -O) >= c && (p = d), w = b(h(h({}, e), {}, {
                                index: t
            ...
            t.Track = function(e) {
                ...
                function o() {
                    ...
                    return y(u(e = i.call.apply(i, [this].concat(r))), "node", null), y(u(e), "handleRef", function(t) {
                        e.node = t
                    }), e
                }
                return r = [{
        ...
        1489: function(e, t, r) {
            ...
            var u = t.safePreventDefault = function(e) {
                ...
                d = t.getOnDemandLazySlides = function(e) {
                    for (var t = [], r = f(e), n = p(e), i = r; i < n; i++) 0 > e.lazyLoadedList.indexOf(i) && t.push(i);
                    return t
                };
            ...
            t.extractObject = function(e, t) {
                ...
                if (n) {
                    if (!i && (o < 0 || o >= a)) return {};
                    o < 0 ? w = o + a : o >= a && (w = o - a), s && 0 > v.indexOf(w) && (v = v.concat(w)), O = {
                        animating: !0,
                        currentSlide: w,
                        lazyLoadedList: v,
                        targetSlide: w
                ...
                } else b = w, w < 0 ? (b = w + a, i ? a % p != 0 && (b = a - a % p) : b = 0) : !m(e) && w > u ? w = b = u : f && w >= a ? (w = i ? a : a - 1, b = i ? 0 : a - 1) : w >= a && (b = w - a, i ? a % p != 0 && (b = 0) : b = a - h), !i && w + h >= a && (b = a - h), g = T(l(l({}, e), {}, {
                    slideIndex: w
                })), S = T(l(l({}, e), {}, {
                    slideIndex: b
                })), i || (g === S && (w = b), g = S), s && (v = v.concat(d(l(l({}, e), {}, {
                    currentSlide: w
                })))), y ? (O = {
                    animating: !0,
                    currentSlide: b,
                ...
                var r, n, i, o, a = e.slidesToScroll,
                    ...
                    f = e.lazyLoad,
                    p = e.infinite;
                if (r = c % a != 0 ? 0 : (c - u) % a, "previous" === t.message) o = u - (i = 0 === r ? a : s - r), f && !p && (o = -1 == (n = u - i) ? c - 1 : n), p || (o = d - a);
                else if ("next" === t.message) o = u + (i = 0 === r ? a : r), f && !p && (o = (u + a) % c + r), p || (o = d + a);
                ...
                return ("IMG" === e.target.tagName && u(e), t && (r || -1 === e.type.indexOf("mouse"))) ? {
                    dragging: !0,
                    touchObject: {
                ...
                if (!r) {
                    ...
                    var C = g(t.touchObject, a),
                        z = w.swipeLength;
                    return !S && (0 === c && ("right" === C || "down" === C) || c + 1 >= Math.ceil(v / b) && ("left" === C || "up" === C) || !m(t) && ("left" === C || "up" === C)) && (z = w.swipeLength * d, !1 === f && p && (p(C), E.edgeDragged = !0)), !h && O && (O(C), E.swiped = !0), _ = i ? x + k / P * z * M : s ? x - z * M : x + z * M, a && (_ = x + z * M), E = l(l({}, E), {}, {
                        touchObject: w,
                        swipeLeft: _,
                        trackStyle: j(l(l({}, t), {}, {
                            left: _
                        }))
                    }), Math.abs(w.curX - w.startX) < .8 * Math.abs(w.curY - w.startY) || w.swipeLength > 10 && (E.swiping = !0, u(e)), E
                }
            ...
            var S = t.getNavigableIndexes = function(e) {
                ...
                O = t.getSlideCount = function(e) {
                    ...
                    if (Array.from(n.querySelectorAll && n.querySelectorAll(".slick-slide") || []).every(function(n) {
                            if (e.vertical) {
                                if (n.offsetTop + b(n) / 2 > -1 * e.swipeLeft) return r = n, !1
                ...
                T = t.getTrackLeft = function(e) {
                    ...
                    if (n ? (v = -_(e), o % s != 0 && t + s > o && (v = -(t > o ? a - (t - o) : o % s)), i && (v += parseInt(a / 2))) : (o % s != 0 && t + s > o && (v = a - o % s), i && (v = parseInt(a / 2))), h = v * l, y = v * d, b = p ? -(t * d * 1) + y : -(t * l * 1) + h, !0 === u) {
                        ...
                        if (m = t + _(e), b = (g = S && S.childNodes[m]) ? -1 * g.offsetLeft : 0, !0 === i) {
                            m = n ? t + _(e) : t, g = S && S.children[m], b = 0;
                            for (var w = 0; w < m; w++) b -= S && S.children[w] && S.children[w].offsetWidth;
